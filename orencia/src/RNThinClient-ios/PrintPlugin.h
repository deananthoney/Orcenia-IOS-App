...
@interface PrintPlugin : CDVPlugin <UIWebViewDelegate, UIPrintInteractionControllerDelegate> {
    ...
    UIWebView *webPrintView;
}

@property (nonatomic, retain) UIWebView *webPrintView;
